            ...
            <div class="item active">
                ...
                <div class="carousel-caption ">
                    <h5>
                     ...
                     </span><span class="fa-stack fa-3x">
                            <i class="fa fa-square fa-stack-2x"></i>
                            <i class="fa fa-share-alt text-success fa-stack-1x "></i>
                     </span><span class="fa-stack fa-4x">
                            <i class="fa fa-square fa-stack-2x"></i>
                            <i class="fa fa-share-alt text-success fa-stack-1x "></i>
                     </span></span><span class="fa-stack fa-3x">
                            <i class="fa fa-square fa-stack-2x"></i>
                            <i class="fa fa-share-alt text-success fa-stack-1x "></i>
                     </span></span></span><span class="fa-stack fa-2x">
                            <i class="fa fa-square fa-stack-2x"></i>
                            <i class="fa fa-share-alt text-success fa-stack-1x "></i>
                     </span>
                </div>
        ...
        <div id="rss" class="col-md-3 col-sm-6">
            <div class="service-item">
                ...
                <p class="text-justify">این روزها همه در فضای آنلاین به دنبال اخبار هستند.
                    از فرصت استفاده کنید و وب سایت خبری کامل داشته باشید. نظرات و عقاید خود را با دیگران به اشتراک بگذارید.
        ...
        <div id="personal" class="col-md-3 col-sm-6">
            <div class="service-item">
                ...
                <p class="text-justify">با داشتن وب سایت شخصی بهتر دیده شوید.
                    میدانید هم اکنون خیلی ها به دنبال شما هستند؟. این فرصت را از دست ندهید.
                    رزومه خود را آنلاین کنید تا از این طریق به موقعیت اجتماعی بهتری دست پیدا کنید. </p>
                <a href="#" class="btn btn-block btn-default">Learn More</a>
            </div>
        </div>
